...
{
        // <summary>
        //inside of the cash repository when we asked for
        // a list of doctors it actually checked the cache first and then if it wasn't in
        // the cache it would go and fetch the result from the EF repository which in
        // turn would make the request to the database
        // </summary>
