...
{
  public class CustomerPublicWebSiteRabbitMqService : BackgroundService
  {
    private IModel _channel;
    private IConnection _connection;
    private readonly string _queuein = MessagingConstants.Queues.FDVCP_FRONTDESK_IN;
    private readonly string _exchangeName = MessagingConstants.Exchanges.FRONTDESK_CUSTOMERPUBLICWEBSITE_EXCHANGE;
    private readonly ILogger<CustomerPublicWebSiteRabbitMqService> _logger;
    private readonly IServiceScopeFactory _serviceScopeFactory;
    private readonly IHubContext<ScheduleHub> _scheduleHub;

    public CustomerPublicWebSiteRabbitMqService(
      IOptions<RabbitMqConfiguration> rabbitMqOptions,
      ILogger<CustomerPublicWebSiteRabbitMqService> logger,
